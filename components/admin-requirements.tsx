...
export function AdminRequirements({ initial, options, initialFilters = EMPTY_FILTERS, allowDeletion=false }: {
  ...
  const activeCount = [applied.cliente,applied.unidad,applied.coordinador,applied.estado,applied.genero,applied.unidadesMin,applied.unidadesMax,applied.desde,applied.hasta,applied.q,applied.duplicados].filter(Boolean).length;
