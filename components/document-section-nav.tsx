...
export function DocumentSectionNav({role}:{role:Role}){
  const documentTypes=[{href:"/documentos/vacaciones",label:"Vacaciones",icon:PlaneTakeoff},...(role==="admin"?[{href:"/documentos/vacaciones/mantenimiento",label:"Mantenimiento",icon:Wrench}]:[])];
