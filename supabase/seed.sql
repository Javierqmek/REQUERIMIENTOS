...
insert into public.prendas (codigo_prenda, nombre_prenda, codigo_almacen, precio, cliente, cantidad) values
  ('PRE001', 'Pantalón táctico', 'ALM001', 85, 'Cliente A', 2),
  ('PRE002', 'Camisa manga larga', 'ALM002', 45, 'Cliente A', 2),
  ('PRE003', 'Casaca invierno', 'ALM003', 120, 'Cliente A', 1),
  ('PRE005', 'Pantalón azul', 'ALM005', 90, 'Cliente B', 2)
