...
export default async function DetailPage({params}:{params:Promise<{id:string}>}){
  ...
  return <section className="mx-auto max-w-3xl"><div className="flex flex-wrap items-start justify-between gap-3"><div><p className="text-sm font-bold text-blue-600">DETALLE DEL REQUERIMIENTO</p><h1 className="mt-1 text-2xl font-black">{row.personal?.nombre}</h1></div><StatusBadge estado={row.estado}/></div>
