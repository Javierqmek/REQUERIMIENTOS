...
const papeletaFixtures: PapeletaRow[] = [{
  ...
  estado: (inboxRole==="gerente"||inboxRole==="admin"?(query.get("pstate")||"REGISTRADO"):"REGISTRADO") as PapeletaEstado,
  version_actual: 1, motivo_observacion: null, archivo_nombre: "papeleta-maria.pdf", es_prueba: false,
  coordinador_id: editProfile.id, provincia_id: "aa100000-0000-4000-8000-000000000001", cliente_id: IDS.cliente, unidad_id: IDS.unidad,
  provincias: { nombre: "AREQUIPA" },
...
const profile = documentDetail&&query.get("role")==="gerente"?{...editProfile,id:documentFixture.firmante_id,role:"gerente" as const,nombre:"Gerente Seguroc"}
  ...
  :vacationsDetail&&query.get("role")==="admin"?{...editProfile,id:"a3000000-0000-4000-8000-000000000001",role:"superadmin" as const}
  ...
  :vacationsList&&query.get("role")==="admin"?{...editProfile,role:"superadmin" as const}
  ...
  :vacationsMaintenance?{...editProfile,role:(query.get("role")==="admin"?"superadmin":"coordinador") as "superadmin"|"coordinador"}
...
createRoot(document.getElementById("root")!).render(
  ...
  {profile.role==="superadmin"&&<VacationTestToggle papeletaId={papeletaDetailFixture.id} esPrueba={papeletaDetailFixture.es_prueba} firmado={papeletaDetailFixture.estado==="FIRMADO"}/>}
